...
$(call inherit-product-if-exists, vendor/Bluboo/Maya/Maya-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/Bluboo/Maya/overlay
PRODUCT_PACKAGE_OVERLAYS += device/Bluboo/Maya/overlay # enable this to be able overlay a default wallpaper

LOCAL_PATH := device/Bluboo/Maya
